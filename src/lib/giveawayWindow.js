...
// (no entries are taken before then). Close date is provisional (founder to
// confirm): 46 days, so the draw does not land on Christmas. Times are UTC so
// the countdown is the same everywhere.
