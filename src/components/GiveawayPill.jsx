...
const GiveawayPill = () => {
  ...
  return (
    <Link
      ...
      aria-label={phase === 'upcoming' ? 'Thank you giveaway: win the gear of your choice. Opens November 15. Open the giveaway page.' : 'Thank you giveaway: win the gear of your choice, up to USD 500. Open the giveaway page.'}
    >
      <Ticket aria-hidden="true" className="size-4 shrink-0" strokeWidth={1.75} />
      <span className="whitespace-nowrap">Thank you giveaway</span>
      <span className="hidden font-mono tracking-normal whitespace-nowrap text-fg-subtle normal-case sm:inline">
        {phase === 'upcoming' ? 'Opens Nov 15' : 'Ends Dec 31'}
      </span>
      <span className="hidden whitespace-nowrap text-fg-muted min-[480px]:inline">{phase === 'upcoming' ? 'Win the gear you pick' : 'Win gear up to $500'}</span>
      <ArrowRight
        aria-hidden="true"
