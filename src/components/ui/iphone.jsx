...
// Local change: `children` render inside the screen cutout (under the frame),
// so a page can crossfade several screens in one phone. `alt` labels `src`.
export function Iphone({
  ...
  // Unique per instance: several phones share a page, and a mask id that
  // resolves into a display:none copy would not render.
  const maskId = `screenPunch-${useId().replace(/:/g, "")}`
