    ...
    return (
        <section id="platforms" ref={sectionRef} className="relative py-28 lg:py-36 px-6">
            ...
            <div className={`relative max-w-5xl mx-auto text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                ...
                {/* Platform Badges */}
                {/* Two equal cards: fixed icon box + stacked label, so the Apple and
                    Android glyphs (different aspect ratios) sit on the same grid. */}
                <div className="mx-auto grid w-full max-w-2xl grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    >
                        <div className="relative flex h-full items-center gap-5 rounded-2xl border border-white/10 bg-white/[0.05] px-7 py-6 transition-all duration-300 hover:border-white/20 hover:bg-white/[0.08]">
                            {/* Apple Icon */}
                            ...
                            <div className="min-w-0 text-left">
                                <p className="text-sm leading-tight text-white/50">Join the beta on</p>
                                <p className="mt-1 text-xl font-semibold leading-tight text-white">TestFlight</p>
                            </div>
                    ...
                    >
                        <div className="relative flex h-full items-center gap-5 rounded-2xl border border-white/10 bg-white/[0.05] px-7 py-6 transition-all duration-300 hover:border-white/20 hover:bg-white/[0.08]">
                            ...
                            <div className="min-w-0 text-left">
                                <p className="text-sm leading-tight text-white/50">Join the beta on</p>
                                <p className="mt-1 text-xl font-semibold leading-tight text-white">Google Play</p>
                            </div>
